...
N1 = [300 325 350 375 400 425 450 475 500 525  500 300 300  420];
N2 = [425 425 450 475 500 525 550 575 600 625 1000 450 1000 1000];

%
% N1 = [300 325 350 375 400 425 450 475  500];
% N2 = [400 425 450 475 500 525 550 575  1000];

% N1 = [300 325 350 375 400 425 450 475 500];
% N2 = [400 425 450 475 500 525 550 1000 1000];
...
N1 = [300 325 350 375 400 425 450 500];
N2 = [400 425 450 475 500 525 550 1000];
% N1 = [325 350 375 400 425 450 ];
% N2 = [425 450 475 500 525 1000];

%  N1 = [ 320 440];
%  N2 = [ 440 1200];

% N1 = [325 350 400 450 500];
% N2 = [425 450 500 600 1000];
%
%
%  N1 = [300 400 475 525];
%  N2 = [400 500 550 1000];
...
% N1 = [300 350 400 450 500 550 600 650 700 750 800];
% N2 = [400 450 500 550 600 650 700 750 800 850 1000];
...
baseDir = '/net/derived/people/chand/';
