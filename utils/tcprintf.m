function tcprintf(style, fmatString, varargin)
    ...
    %   black, red, green, yellow, blue, magenta, cyan, darkGray, lightGray, white
    %
...
function [colorName backColorName bright underline blink] = parseStyle(style)
    ...
    colorList = {'black', 'darkGray', 'lightGray', 'red', 'r', 'green', 'g', 'yellow','y',...
        'blue', 'magenta','m', 'cyan', 'lightGray', 'white', 'default'};
